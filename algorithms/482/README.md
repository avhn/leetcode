...
<b>Explanation:</b> The string S has been split into three parts, each part has 2
...
**Note:**
  ...
  2. String S consists only of alphanumerical characters (a-z and/or A-Z and/or 0-9) and
  dashes(-).
